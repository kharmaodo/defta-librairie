...
func NewPaymentHandler(service *services.PaymentService) *PaymentHandler { return &PaymentHandler{service: service} }
...
func (h *PaymentHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil { writePaymentError(w, err); return }
...
func (h *PaymentHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if decodeOwnerJSON(w, r, &input) != nil { writePaymentError(w, services.ErrInvalidPayment); return }
	claims, _ := auth.ClaimsFromContext(r.Context())
