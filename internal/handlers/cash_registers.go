...
func (h *CashRegisterHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if decodeOwnerJSON(w, r, &input) != nil {
		writeCashRegisterError(w, services.ErrInvalidCashRegister)
		return
	}
	claims, _ := auth.ClaimsFromContext(r.Context())
...
func (h *CashRegisterHandler) Disable(w http.ResponseWriter, r *http.Request) {
	h.changeStatus(w, r, false)
}
func (h *CashRegisterHandler) Reactivate(w http.ResponseWriter, r *http.Request) {
