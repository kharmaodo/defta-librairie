...
func (s *loginStoreStub) FindByUsername(context.Context, string) (models.User, error) {
	return s.user, s.findErr
}
func (s *loginStoreStub) RecordFailedLogin(context.Context, string, string, string, string, string) error {
	s.failed++
	return nil
}
func (s *loginStoreStub) RecordSuccessfulLogin(context.Context, string, string, string, string) error {
	s.succeeded++
	return nil
}
func (s *loginStoreStub) RecordUnknownLogin(context.Context, string, string, string) error {
	s.unknown++
	return nil
}
