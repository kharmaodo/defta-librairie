...
État consolidé le 14 septembre 2026 sur `develop`, commit `55ff3e5`
(fondation de la refonte `v1.1.0` fusionnée par la PR #53). Les douze priorités et leurs éléments
...
| 2 | Structure du dashboard | Header modernisé, navigation thématique, sous-menus accessibles et ancres de sections | En cours |
