...
| 4 | US-4 — Limites de ressources | Limites et comportement mesurés pour upload de couverture, recherche FTS, pagination, exports et endpoints coûteux ; réponses d’erreur cohérentes | API4, API6 | En validation — recherche catalogue bornée et matrice des limites |
