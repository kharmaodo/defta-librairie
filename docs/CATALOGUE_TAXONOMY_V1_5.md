...
|---|---|---|
| 1 | Fondation, seed et migrations | Seed idempotent AR/FR/EN ; rollback logique et données legacy préservées |
| 2 | CRUD catégories et éditeurs | Root, propriétaire cloisonné, désactivation, audit et OpenAPI |
