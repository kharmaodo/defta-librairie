...
navigateur. La recette automatisée d’accessibilité couvre les garanties clavier
principales sans se substituer à un audit manuel avec lecteur d’écran. Ne déclarer ce
