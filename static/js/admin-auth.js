(() => {
  ...
  const state = {isRoot: false, passwordChangeRequired: false, sales: [], saleBooks: [], saleCustomers: [], tags: [], saleOffset: 0, saleLimit: 10};
  ...
  let audit, sessions, owners, books, inventory;
